...
public static class AstNodesExtensions
{
    ...
    public static Assignment Assign(this Assignable left, Expression value) => Assign(left, value, out _);

    public static Assignment Assign(this Assignable left, Expression value, out Assignment result) =>
