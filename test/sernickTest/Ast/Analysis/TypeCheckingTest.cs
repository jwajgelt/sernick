...
public class NameResolutionTest
{
    ...
    public class TestSimpleExpressions
    {
        ...
        public void ExpressionWithSingleIntLiteral(){
            ...
            Assert.same(new IntType(), result.ExpressionTypes[literal23]);
            Assert.same(new IntType(), result.ExpressionsTypes[tree]);
        }
        ...
        public void ExpressionWithSingleBoolLiteral()
        {
            ...
            var result = null; // TODO 
            Assert.same(new BoolType(), result.ExpressionTypes[literalTrue]);
            Assert.same(new BoolType(), result.ExpressionsTypes[tree]);
        }
        ...
        public void ExpressionWithChainedLiterals(){
            ...
            Assert.same(new BoolType(), result.ExpressionTypes[literalFalse]);
            Assert.same(new IntType(), result.ExpressionTypes[literal42]);
            Assert.same(new BoolType(), result.ExpressionsTypes[tree]);
        }
    ...
    private static LiteralValue GetBoolLiteral(boolean b){
